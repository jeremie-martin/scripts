...
SUT_REQUIREMENTS_TO_TESTS_MAPPING = {
    ...
    "ABSD-DI2_SUT-122": [    # Terminal feedback - Covered by all tests that verify reporting
        "ABSD-SWVER-322", "ABSD-SWVER-373", "ABSD-SWVER-383", "ABSD-SWVER-384", 
        "ABSD-SWVER-385", "ABSD-SWVER-388", "ABSD-SWVER-389"
    ],

    # Core Update Functionality
    "ABSD-DI2_SUT-123": [    # FPGA Version update - No specific FPGA unit tests in provided list
        "ABSD-SWVER-286", "ABSD-SWVER-287"  # CRC tests support file integrity for updates
    ],
    "ABSD-DI2_SUT-124": [    # MCU Version update - Covered by MCU state and command tests
        "ABSD-SWVER-351", "ABSD-SWVER-352", "ABSD-SWVER-353", "ABSD-SWVER-354", "ABSD-SWVER-360"
    ],
    "ABSD-DI2_SUT-125": [    # Abort update - Covered by error handling and protocol tests
        "ABSD-SWVER-322", "ABSD-SWVER-373", "ABSD-SWVER-388", "ABSD-SWVER-389"
    ],
    ...
    "ABSD-DI2_SUT-116": [    # Connection USB Configuration link
        "ABSD-SWVER-322", "ABSD-SWVER-323", "ABSD-SWVER-324"  # All SerialLink tests
    ],
    ...
    "ABSD-DI2_SUT-85": [     # USB Configuration Link Command Reply Verification
        "ABSD-SWVER-373", "ABSD-SWVER-383", "ABSD-SWVER-384", "ABSD-SWVER-385",
        "ABSD-SWVER-388", "ABSD-SWVER-389", "ABSD-SWVER-393", "ABSD-SWVER-394", "ABSD-SWVER-395"
    ],
    "ABSD-DI2_SUT-86": [     # Extended Commands Timeout (2500ms) - No specific 2500ms tests in provided list
        "ABSD-SWVER-367", "ABSD-SWVER-373", "ABSD-SWVER-388", "ABSD-SWVER-390", "ABSD-SWVER-392", "ABSD-SWVER-395"
    ],
    ...
    "ABSD-DI2_SUT-88": [     # Command Reply Validation
        "ABSD-SWVER-373", "ABSD-SWVER-383", "ABSD-SWVER-384", "ABSD-SWVER-385", 
        "ABSD-SWVER-389", "ABSD-SWVER-394", "ABSD-SWVER-395"
    ],
    "ABSD-DI2_SUT-89": [     # Command Execution Retry (within 100ms)
        "ABSD-SWVER-373", "ABSD-SWVER-388", "ABSD-SWVER-389", "ABSD-SWVER-385"
    ],
    "ABSD-DI2_SUT-90": [     # Command Failure (after 3 transmissions) - No specific 3-retry failure tests
        "ABSD-SWVER-373", "ABSD-SWVER-388", "ABSD-SWVER-389"
    ],
    ...
    "ABSD-DI2_SUT-101": [    # Query FW Version
        "ABSD-SWVER-351", "ABSD-SWVER-352", "ABSD-SWVER-353", "ABSD-SWVER-354"  # MCU FW state tests
    ],
    "ABSD-DI2_SUT-102": [    # FW up to date (proceed only when different)
        "ABSD-SWVER-351", "ABSD-SWVER-352"  # MCU FW state tests can verify version comparison
    ],
    "ABSD-DI2_SUT-103": [    # Log and Report FW up to date
        "ABSD-SWVER-351", "ABSD-SWVER-352", "ABSD-SWVER-353", "ABSD-SWVER-354"
    ],
    "ABSD-DI2_SUT-104": [    # Implant not up to date (transfer when different)
        "ABSD-SWVER-351", "ABSD-SWVER-352"  # MCU FW state tests
    ],
    "ABSD-DI2_SUT-105": [    # Log and Report FW Update progress (10% intervals)
        "ABSD-SWVER-351", "ABSD-SWVER-352", "ABSD-SWVER-353", "ABSD-SWVER-354"
    ],
    "ABSD-DI2_SUT-106": [    # FW File transfer integrity
        "ABSD-SWVER-286", "ABSD-SWVER-287"  # CRC computation tests for integrity verification
    ],
    ...
    "ABSD-DI2_SUT-109": [    # FW Version Error
        "ABSD-SWVER-351", "ABSD-SWVER-352", "ABSD-SWVER-373", "ABSD-SWVER-388", "ABSD-SWVER-389"
    ],
    ...
    "ABSD-DI2_SUT-91": [     # Query FPGA Version - No specific FPGA query tests
        "ABSD-SWVER-343", "ABSD-SWVER-345"  # Device ID queries might be related
    ],
    "ABSD-DI2_SUT-92": [     # FPGA up to date (proceed only when different)
        "ABSD-SWVER-286", "ABSD-SWVER-287"  # CRC tests for version comparison integrity
    ],
    "ABSD-DI2_SUT-93": [     # Log and Report FPGA up to date
        "ABSD-SWVER-286", "ABSD-SWVER-287", "ABSD-SWVER-343", "ABSD-SWVER-345"
    ],
    "ABSD-DI2_SUT-94": [     # Implant FPGA not up to date (transfer when different)
        "ABSD-SWVER-286", "ABSD-SWVER-287"
    ],
    "ABSD-DI2_SUT-95": [     # Log and Report FPGA Update progress (10% intervals)
        "ABSD-SWVER-286", "ABSD-SWVER-287", "ABSD-SWVER-367"  # CRC + timing
    ],
    "ABSD-DI2_SUT-96": [     # FPGA File transfer integrity
        "ABSD-SWVER-286", "ABSD-SWVER-287"  # CRC computation tests
    ],
    ...
    "ABSD-DI2_SUT-111": [    # Wearable start-up sequence
        "ABSD-SWVER-343", "ABSD-SWVER-350", "ABSD-SWVER-351", "ABSD-SWVER-352"  # Device/state queries
    ],
    "ABSD-DI2_SUT-112": [    # Wearable start-up failure
        "ABSD-SWVER-322", "ABSD-SWVER-373", "ABSD-SWVER-388", "ABSD-SWVER-389"
    ],
    "ABSD-DI2_SUT-113": [    # Power-up implant
        "ABSD-SWVER-350", "ABSD-SWVER-360"  # Enable wireless power + MCU reboot
    ],
    "ABSD-DI2_SUT-114": [    # Implant Start-Up Sequence
        "ABSD-SWVER-345", "ABSD-SWVER-346", "ABSD-SWVER-351", "ABSD-SWVER-352", "ABSD-SWVER-360"
    ],
    "ABSD-DI2_SUT-115": [    # Implant start-up failure
        "ABSD-SWVER-322", "ABSD-SWVER-351", "ABSD-SWVER-352", "ABSD-SWVER-360", 
        "ABSD-SWVER-373", "ABSD-SWVER-388", "ABSD-SWVER-389"
    ],
    ...
    "ABSD-DI2_SUT-72": [     # Logs SUT at start-up - New log file each launch
        "ABSD-SWVER-343", "ABSD-SWVER-345", "ABSD-SWVER-346"  # Initial startup commands
    ],
    ...
    "ABSD-DI2_SUT-74": [     # SUT log human readable
        "ABSD-SWVER-353", "ABSD-SWVER-354"  # String format tests for MCU states
    ],
    ...
    "ABSD-DI2_SUT-76": [     # SUT log levels (INFO, ERROR)
        "ABSD-SWVER-322", "ABSD-SWVER-373", "ABSD-SWVER-388", "ABSD-SWVER-389"  # Error handling tests
    ],
    "ABSD-DI2_SUT-77": [     # Log and Report Implant Power-On
        "ABSD-SWVER-350", "ABSD-SWVER-360"  # Power and reboot commands
    ],
    "ABSD-DI2_SUT-78": [     # Log and Report Implant Start-Up
        "ABSD-SWVER-345", "ABSD-SWVER-346", "ABSD-SWVER-351", "ABSD-SWVER-352", "ABSD-SWVER-360"
    ],
    "ABSD-DI2_SUT-79": [     # Log and Report Wearable Start-Up
        "ABSD-SWVER-343", "ABSD-SWVER-350", "ABSD-SWVER-351", "ABSD-SWVER-352"
    ],
    ...
    "ABSD-DI2_SUT-84": [     # SUT Logs and Reports versions at Start-up
        "ABSD-SWVER-343", "ABSD-SWVER-345", "ABSD-SWVER-346", "ABSD-SWVER-351", 
        "ABSD-SWVER-352", "ABSD-SWVER-353", "ABSD-SWVER-354"
    ],
}
...
class JamaAutoLinker:
    ...
    def print_final_stats(self) -> None:
        ...
        success_rate = ((self.stats["successful_links"] + self.stats["skipped_links"]) / self.stats["total_mappings"] * 100) if self.stats["total_mappings"] > 0 else 0
...
def main():
    ...
    parser.add_argument(
        ...
        help="Show coverage analysis only"
    )
